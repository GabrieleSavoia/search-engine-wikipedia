...
class WikiSchema(SchemaClass):
    ...
    text = TEXT(analyzer=StemmingAnalyzer_(), stored=True, phrase=False)     #phrase=False per ridurre index
    title = TEXT(analyzer=StandardAnalyzer_(), stored=True, phrase=False)
